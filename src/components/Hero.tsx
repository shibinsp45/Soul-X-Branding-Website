...
const Hero = () => {
  ...
  return (
    ...
    >
      ...
      <div 
        className="absolute top-1/4 left-10 w-16 h-16 border border-foreground/10 rounded-2xl float-3d"
        style={{ animationDelay: "0s" }} 
      />
      <div 
        className="absolute top-1/3 right-20 w-24 h-24 border border-foreground/5 rounded-full float-3d" 
        style={{ animationDelay: "2s" }} 
      />
      <div 
        className="absolute bottom-1/3 left-1/4 w-12 h-12 border border-foreground/10 rotate-45 float-3d" 
        style={{ animationDelay: "4s" }} 
      />
      <div 
        className="absolute top-1/2 right-1/4 w-20 h-20 bg-foreground/[0.02] rounded-full blob-morph" 
      />
      ...
      <div className="container px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        >
          ...
          <h1 
            className="text-5xl sm:text-6xl md:text-7xl lg:text-8xl xl:text-9xl font-display font-medium leading-[0.95] tracking-tighter text-foreground opacity-0 animate-blur-in" 
            style={{ animationDelay: "0.3s" }}
          >
            <span className="inline-block hover:animate-tilt transition-transform">Crafting</span>
            <br />
            <span className="font-serif italic font-normal relative inline-block hover:animate-tilt">
              Seamless
              <svg 
          ...
          {/* Motto */}
          <p 
            className="mt-8 text-lg md:text-xl lg:text-2xl text-muted-foreground max-w-2xl mx-auto leading-relaxed opacity-0 animate-slide-up-fade font-light" 
          ...
          <div 
            className="mt-12 flex flex-col sm:flex-row gap-4 justify-center opacity-0 animate-slide-up-fade" 
            style={{ animationDelay: "0.7s" }}
          >
            <a 
              href="#projects" 
              className="button-primary inline-flex items-center justify-center group text-lg tilt-hover"
            >
              View Our Work
            ...
            <a 
              href="#contact" 
              className="button-secondary inline-flex items-center justify-center text-lg tilt-hover"
            >
          ...
          <div 
            className="mt-20 grid grid-cols-3 gap-8 max-w-xl mx-auto opacity-0 animate-slide-up-fade"
