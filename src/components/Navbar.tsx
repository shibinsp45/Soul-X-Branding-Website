    ...
    >
      <div className="container flex items-center justify-between px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex items-center gap-3 z-[60]">
          ...
          {/* Mobile menu button */}
          <button 
            className="md:hidden text-foreground p-2 focus:outline-none focus:ring-2 focus:ring-primary/50 rounded-lg" 
            onClick={toggleMenu} 
      ...
      <div 
        ...
        ref={menuRef}
        className={cn(
          "fixed inset-0 z-[55] md:hidden transition-all duration-500 ease-out",
          isMenuOpen 
            ? "opacity-100 visible" 
      ...
      >
        ...
        <div className={cn(
          "relative h-full flex flex-col transition-transform duration-500 ease-out",
          ...
          <div className="flex justify-end items-center px-6 py-4 pt-5">
            <button 
              ...
              className="text-foreground p-3 focus:outline-none focus:ring-2 focus:ring-primary/50 hover:bg-foreground/5 rounded-full transition-colors" 
              onClick={closeMenu} 
          ...
          <div className={cn(
            "p-8 text-center transition-all duration-500 ease-out",
            isMenuOpen 
